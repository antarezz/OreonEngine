...
public class FXAA {
	...
	public FXAA(){
		...
		fxaaSceneTexture = new TextureImage2D(BaseOreonContext.getWindow().getWidth(), BaseOreonContext.getWindow().getHeight(),
	...
	public void render(GLTexture sceneTexture){
		...
		glDispatchCompute(BaseOreonContext.getWindow().getWidth()/16, BaseOreonContext.getWindow().getHeight()/16, 1);
	}
